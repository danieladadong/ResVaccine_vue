<template>
  <div class="mod-config">
      ...
      <!-- 弹窗, 新增 / 修改 -->
      <editvaccine v-if="addOrUpdateVisible" ref="VaccineAddOrUpdate"></editvaccine>
...
import {getVaccine,getVaccines,deleteVaccine,adultVaccine} from '@/api/modules/vaccines'
